  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <h1>Build beautiful space at the speed of thought with Roomify</h1>
        <p className="subtitle">
          Roomify is an AI-first design environment that helps you visualize, render, and ship architectural project
          faster then ever.
        </p>
